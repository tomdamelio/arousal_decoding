...
def global_preprocessing(number_subject = subject_number,              
    ...
    for subject in number_subject:   
        ...
        if annotations is not None:
            # read annotations
            fname_annot = op.join(annotations,'sub-'+ subject + '_annotations.fif')
        ...
        ec = mne.Epochs(raw, events,
                        event_id=3000, tmin=0, tmax=pp.duration, proj=True,
